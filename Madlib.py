...
print(f"to {noun3} In ")
print(f"a {adjective} {adjective2} boat, They took")
print(f"some {noun4}, and plenty ")
print(f"of {noun5}, Wrapped up ")
print(f"in a five-pound note. The {noun}looked up to the ")
print(f"{noun6}O lovely {noun2}! O")
